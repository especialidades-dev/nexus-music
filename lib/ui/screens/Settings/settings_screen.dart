...
import 'package:nexusmusic/utils/lang_mapping.dart';
                        ...
                        child: Material(
                          ...
                          child: ListTile(
                            onTap: () {
                              launchUrl(
                                Uri.parse(
                                  'https://github.com/especialidades-dev/nexus-music/releases/latest',
                                ),
                ...
                children: [
                  ListTile(
                    ...
                    onTap: () {
                      launchUrl(
                        Uri.parse(
                          'https://github.com/especialidades-dev/nexus-music',
                        ),
                        mode: LaunchMode.externalApplication,
                      );
                    },
